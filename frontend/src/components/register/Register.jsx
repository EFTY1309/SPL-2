      ...
      case "admin":
        return (
          <div>
            ...
            />
            <br />
            <label htmlFor="adminPosition">Professional Position</label>
            <br />
            <input
              type="text"
              value={adminData.professionalPosition}
              id="adminPosition"
    ...
    <div className="App">
      ...
      {!registrationType && (
        <div className="registration-button">
          <button onClick={() => handleRegistrationTypeSelect("swimmer")}>
            Swimmer Registration
          </button>
          <button onClick={() => handleRegistrationTypeSelect("admin")}>
            Admin Registration
          </button>
          <button onClick={() => handleRegistrationTypeSelect("staff")}>
            Staff Registration
          </button>
        </div>
      )}
